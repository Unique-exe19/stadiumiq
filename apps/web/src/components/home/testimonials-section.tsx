...
function SaudiFlag() {
  return (
    <svg width="20" height="14" viewBox="0 0 20 14" aria-label="Saudi Arabia flag" role="img">
      ...
      <text x="3" y="9.5" fontSize="5.5" fill="white" fontFamily="serif">
        الله
      </text>
...
const TESTIMONIALS = [
  {
    quote:
      'StadiumIQ guided us from the metro to our seats in under 5 minutes, even with my wheelchair. The audio navigation was incredible.',
    author: 'Maria S.',
  ...
  {
    quote:
      'The crowd predictions were spot-on. We redirected 800 fans before a bottleneck even formed. This is what modern stadium management looks like.',
    author: 'James K.',
    role: 'Venue Manager',
    country: 'USA',
      ...
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-14">
          ...
          <h2
            ...
            className="text-3xl font-display font-bold text-slate-900 mt-3"
          >
