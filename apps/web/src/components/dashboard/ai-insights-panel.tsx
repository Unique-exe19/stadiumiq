...
const AI_INSIGHTS = [
  {
    ...
    category: 'Crowd',
    insight:
      'East Concourse will reach critical density in ~12 minutes based on current ingress rate. Open Gate E2 immediately.',
    confidence: 91,
    severity: 'critical',
    action: 'Open Gate E2',
  },
  {
    ...
    category: 'Transport',
    insight:
      'Post-match shuttle demand will peak at 22:15. Recommend 3 additional buses on Route 7.',
    confidence: 87,
    severity: 'warning',
  ...
  },
  {
    ...
    insight:
      'Energy consumption is 12% above target. North wing lights at full brightness — reduce to 70%.',
    confidence: 95,
    severity: 'info',
